...
export default function Login() {
    ...
    return (
        <div className={'grid grid-cols-12 mt-10 m-32 h-[520px] relative shadow-xl rounded-xl overflow-hidden'}>
            {/* Left Side */}
            <div className={`col-span-6 bg-gradient-to-br rounded from-blue-500 to-blue-700 w-[600px] flex flex-col items-start justify-center p-10
            ...
            {/* Right Side */}
            <div className={`rounded col-span-6 bg-gradient-to-br from-amber-50 to-amber-100 w-[600px] flex flex-col items-center justify-center
                transition-transform duration-700 ease-in-out 
                ${sign ? '-translate-x-full' : 'translate-x-0'} 
                absolute right-0 top-0 h-full text-blue-700`}>
                <p className={'text-[50px] font-bold mb-5'}>{sign ? "ثبت نام" : "ورود"}</p>
                <div className="text-center">
                    <p className="text-lg mb-4">
                        {sign ? "فرم ثبت نام خود را پر کنید" : "لطفاً اطلاعات ورود خود را وارد کنید"}
                    </p>
