        ...
        <div className={'p-2 bg-amber-50 mt-4'}>
            <div className={'grid grid-cols-12 mt-4 '}>
                <div className={'col-span-4 flex justify-evenly'}>
                    ...
                    <input type="text" placeholder={'موضوع دلخواه را وارد کنید'}
                           className={'bg-gray-100 rounded placeholder:text-black placeholder:p-2'}/>
                </div>
                <div className={'col-span-4 flex justify-evenly'}>
                    <p>انتخاب دسته بندی</p>
                    <select name="انتخاب دسته بندی" id=""
                            className={'w-[200px] bg-gray-100 rounded placeholder:text-black placeholder:p-2'}>
            ...
            <div className={'grid grid-cols-12 mt-8'}>
                <div className={'col-span-12 flex justify-evenly items-center m-8'}>
                    ...
                    <textarea
                        className={'min-w-[1000px] min-h-64 bg-gray-100 rounded placeholder:text-black placeholder:p-2 '}/>
                </div>
            </div>
            <div className={'grid grid-cols-12 mt-4 mb-5'}>
                ...
                <div className={'col-span-6 flex justify-evenly'}>
                    ...
                    <input className={'bg-gray-100 rounded placeholder:text-black placeholder:p-2'} type="text"/>
                </div>
            </div>
            <div className={'grid grid-cols-12 mt-8 '}>
                <div className={'col-span-12 flex justify-evenly'}>
                    ...
                    <div className={'flex justify-between'}>
                        <input type="text"
                               className={'bg-gray-100 rounded placeholder:text-black placeholder:p-2 ml-5'}/>
                        <p>تا</p>
                        <input type="text"
                               className={'bg-gray-100 rounded placeholder:text-black placeholder:p-2 ms-5'}/>
                    </div>
                </div>
